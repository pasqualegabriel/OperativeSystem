...
from Prototipo.loader import LoaderBlocks
...
class MyTestCase(unittest.TestCase):
    ...
    def testMemory(self):
        ...
        self._loader.freeMemory(self._PCBProgram1.get_bd(), self._PCBProgram1.get_limit(), self._PCBProgram1.get_pid())
        ...
        # Se elimina un programa
        self._loader.freeMemory(self._PCBProgram3.get_bd(), self._PCBProgram3.get_limit(), self._PCBProgram3.get_pid())
        ...
        # Se elimina un programa
        self._loader.freeMemory(self._PCBProgram2.get_bd(), self._PCBProgram2.get_limit(), self._PCBProgram2.get_pid())
        ...
        self._loader.load(self._PCBProgram5.get_bd(), self._program5)
        ...
        # Se elimina un programa
        self._loader.freeMemory(self._PCBProgram4.get_bd(), self._PCBProgram4.get_limit(), self._PCBProgram4.get_pid())
        ...
        # Se elimina un programa
        self._loader.freeMemory(self._PCBProgram5.get_bd(), self._PCBProgram5.get_limit(), self._PCBProgram5.get_pid())
