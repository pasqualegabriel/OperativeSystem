...
class tester(unittest.TestCase):
    ...
    def test000ElDeviceManagerHandleaUnIO_1EnUnTick(self):
        ...
        self.assertEqual(1, self._deviceManager.lenQueueWaiting())
        self._deviceManager.tick()
        self.assertEqual(0,self._deviceManager.lenQueueWaiting())
    ...
    def test003ElDeviceManagerHandleaUnIo_1IO_2yIO_3EnElMismoTick(self):
        ...
        self.assertEqual(3, self._deviceManager.lenQueueWaiting())
        self._deviceManager.tick()
        self.assertEqual(0,self._deviceManager.lenQueueWaiting())
