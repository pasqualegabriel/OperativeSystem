...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self._loader = Loader(self._memory, Mmu(self._memory), Disco(), self._memoryManager)

        # Se cargan cinco programas a memoria
        self._loader.cargarInMemory(self._PCBProgram1, self._program1)
        self._loader.cargarInMemory(self._PCBProgram2, self._program2)
        self._loader.cargarInMemory(self._PCBProgram3, self._program3)
        self._loader.cargarInMemory(self._PCBProgram4, self._program4)
        self._loader.cargarInMemory(self._PCBProgram5, self._program5)
    ...
    def testCompactacion(self):
        ...
        self.assertFalse(self._memoryManager.hayBloqueParaElPrograma(10))
        self._loader.liberarMemoria(self._PCBProgram1.get_bd(), self._PCBProgram1.get_limit(), self._PCBProgram1.get_pid())
        self._loader.liberarMemoria(self._PCBProgram4.get_bd(), self._PCBProgram4.get_limit(), self._PCBProgram4.get_pid())
        ...
        self.assertTrue(self._memoryManager.hayBloqueParaElPrograma(10))
